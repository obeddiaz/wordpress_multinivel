...
$afiliado = get_user_meta($current_user->ID, 'afiliado_de');
?>
...
<div class="wrap">
    ...
    <input type="text" readonly="readonly" value="<?= home_url('/register-form') ?>?userinv=<?= $current_user->ID ?>" style="width: 600px;"/>
    <span>Comparta este link con las personas que desea invitar</span>
